...
io::RootFileSaver saver("plots.root","fit_JES");
...
void resultSummary(FitResult referenceResult,SummaryMode_t summaryMode,FitMode_t fitMode)
{
 ...
 //     box.DrawBox(referenceResult.r2-errorgJets,0,referenceResult.r2+errorgJets,1);
   ...
   io::Logger fit_result_weights(("JES_fitresult.tex"));
...
void run (FitMode_t fitMode){
   ...
   referenceResult=fit("pre_ph165/c_MET100/MT100/METl300vMTl300/","absphiMETnJetPh",{0,.8,3.2},{.2,.4},fitCombinations,fixedBkg,fitMode,0);
   fit("pre_ph165/c_MET100/MT100/METl300vMTl300/","absphiMETnJetPh_JESu",{0,.8,3.2},{.2,.4},fitCombinations,fixedBkg,fitMode,1);
   fit("pre_ph165/c_MET100/MT100/METl300vMTl300/","absphiMETnJetPh_JESd",{0,.8,3.2},{.2,.4},fitCombinations,fixedBkg,fitMode,2);
