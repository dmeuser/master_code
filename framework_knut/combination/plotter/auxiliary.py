...
def getXsecInfoSMS( mother_mass, pklfilename, mother_mass2=0 ):
    info = (0,0)
    with open( pklfilename, 'rb') as f:
        data = pickle.load( f )
        if pklfilename.find("GGM")!=-1 and mother_mass in data:
            if mother_mass2 in data[mother_mass]:
                info = data[mother_mass][mother_mass2]
            else:
                print "could not find mass2 {} in file {}".format(mother_mass2, pklfilename)
        elif mother_mass in data:
