  ...
  if (fLHAPDF6)
    {
      ...
      //~ file << "/home/home4/institut_1b/dmeuser/master_code/LHAPDF_old/local/share/LHAPDF/" << grid << "/" << name << ".info";
      file << grid << "/" << name << ".info";
...
extern"C" {
  ...
  void initnnset_(const char* setname, int* mem)
  {
    if (pdf) delete pdf;
    pdf = new NNPDFDriver(setname, *mem);
  }
